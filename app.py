...
# ==========================================
    ...
    if not st.session_state.admin_logged:
        ...
        # Filtra e exibe estritamente os itens pertencentes àquele pedido escolhido
        df_itens_pedido = df_registros[df_registros['pedido_id'] == pedido_escolhido]
        st.dataframe(df_itens_pedido, use_container_width=True, hide_index=True)                        with col_btn_conv:
                            st.write("") 
