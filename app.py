...
from reportlab.lib import colorsaimport streamlit as st
import sqlite3
import pandas as pd
from datetime import datetime, date, timedelta
from reportlab.lib.pagesizes import letter
...
# Bloco do botão de finalizar venda devidamente alinhado:
    ...
    if st.session_state.carrinho_compras:
        ...
        with col_limpar:
            if st.button("🗑️ Esvaziar Carrinho"):
                st.session_state.carrinho_compras = []
                st.rerun()from reportlab.platypus import SimpleDocTemplate, Paragraph, Spacer, Table, TableStyle
from reportlab.lib.styles import getSampleStyleSheet, ParagraphStyle
import io
import pandas as pd
import datetime as dt
